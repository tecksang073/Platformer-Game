...
/* Load all texture files from resource folder
*  - font
*  - soundEffect
*  - texturePack
*/
...
{
	/*FONT*/
	font.loadFromFile("resource/font/ArchivoBlack.otf");

	/*MUSIC*/
	music.openFromFile("resource/soundEffect/backgroundEffect.ogg");
	music.setLoop(true);
	music.play();
	/*RESTART*/
	restartText.loadFromFile("resource/texturePack/restart.png");
	...
	/*GAMEWIN*/
	gameWinText.loadFromFile("resource/texturePack/win.png");
	...
	/*CHEST*/
	chestText.loadFromFile("resource/texturePack/chest.png");
	chestSprite.setTexture(chestText);
	chestSprite.setPosition(sf::Vector2f(1975, 525));
	chestSprite.setOrigin(sf::Vector2f(25.f, 25.f));

	/*SOUNDEFFECT*/
	coinBuffer.loadFromFile("resource/soundEffect/coinEffect.ogg");
	coinEffect.setBuffer(coinBuffer);
	jumpBuffer.loadFromFile("resource/soundEffect/jumpEffect.ogg");
	jumpEffect.setBuffer(jumpBuffer);
	gameOverBuffer.loadFromFile("resource/soundEffect/gameOverEffect.ogg");
	gameOverEffect.setBuffer(gameOverBuffer);
	winBuffer.loadFromFile("resource/soundEffect/winEffect.ogg");
	winEffect.setBuffer(winBuffer);

	/*COINTEXT*/
	coinPoint.setFont(font);
	coinPoint.setCharacterSize(30);
	coinPoint.setFillColor(sf::Color::White);
	coinPoint.setPosition(sf::Vector2f(125, 55));
	coinPoint.setString('0');

	/*GROUND*/
	ground4Text.loadFromFile("resource/texturePack/groundText/ground4.png");
	ground4Sprite.setTexture(ground4Text);
	ground4Sprite.setOrigin(100.f, 25.f);
	ground1Text.loadFromFile("resource/texturePack/groundText/ground1.png");
	ground1Sprite.setTexture(ground1Text);
	ground1Sprite.setOrigin(25.f, 25.f);

	/*BACKGROUND*/
	backgroundText.loadFromFile("resource/texturePack/background.jpg");
	backgroundSprite.setTexture(backgroundText);

	/*SPIKEUP*/
	spikeUpText.loadFromFile("resource/texturePack/enemyText/spikeUp.png");
	setSpikeUpSprite();

	/*COIN*/
	coinText[0].loadFromFile("resource/texturePack/coinText/1.png");
	coinText[1].loadFromFile("resource/texturePack/coinText/2.png");
	coinText[2].loadFromFile("resource/texturePack/coinText/3.png");
	coinText[3].loadFromFile("resource/texturePack/coinText/4.png");
	coinText[4].loadFromFile("resource/texturePack/coinText/5.png");
	coinText[5].loadFromFile("resource/texturePack/coinText/6.png");
	coinText[6].loadFromFile("resource/texturePack/coinText/7.png");
	coinText[7].loadFromFile("resource/texturePack/coinText/8.png");
	coinText[8].loadFromFile("resource/texturePack/coinText/9.png");
	coinText[9].loadFromFile("resource/texturePack/coinText/10.png");
	coinText[10].loadFromFile("resource/texturePack/coinText/11.png");
	coinText[11].loadFromFile("resource/texturePack/coinText/12.png");
	coinText[12].loadFromFile("resource/texturePack/coinText/13.png");
	coinText[13].loadFromFile("resource/texturePack/coinText/14.png");
	coinText[14].loadFromFile("resource/texturePack/coinText/15.png");
	coinText[15].loadFromFile("resource/texturePack/coinText/16.png");
	coinLogoText.loadFromFile("resource/texturePack/coin.png");
	setCoinSprite();

	/*WATER*/
	waterText[0].loadFromFile("resource/texturePack/waterText/1.png");
	waterText[1].loadFromFile("resource/texturePack/waterText/2.png");
	waterText[2].loadFromFile("resource/texturePack/waterText/3.png");
	waterText[3].loadFromFile("resource/texturePack/waterText/4.png");
	waterText[4].loadFromFile("resource/texturePack/waterText/5.png");
	waterText[5].loadFromFile("resource/texturePack/waterText/6.png");
	waterText[6].loadFromFile("resource/texturePack/waterText/7.png");
	waterText[7].loadFromFile("resource/texturePack/waterText/8.png");
	waterText[8].loadFromFile("resource/texturePack/waterText/9.png");
	waterText[9].loadFromFile("resource/texturePack/waterText/10.png");
	waterText[10].loadFromFile("resource/texturePack/waterText/11.png");
	waterText[11].loadFromFile("resource/texturePack/waterText/12.png");
	waterText[12].loadFromFile("resource/texturePack/waterText/13.png");
	waterText[13].loadFromFile("resource/texturePack/waterText/14.png");
	waterText[14].loadFromFile("resource/texturePack/waterText/15.png");
	waterText[15].loadFromFile("resource/texturePack/waterText/16.png");
	waterText[16].loadFromFile("resource/texturePack/waterText/17.png");
	setWaterSprite();

	/*IDLERIGHT*/
	textureIdleRIGHT[0].loadFromFile("resource/texturePack/idleRightText/image_part_001.png");
	textureIdleRIGHT[1].loadFromFile("resource/texturePack/idleRightText/image_part_002.png");
	textureIdleRIGHT[2].loadFromFile("resource/texturePack/idleRightText/image_part_003.png");
	textureIdleRIGHT[3].loadFromFile("resource/texturePack/idleRightText/image_part_004.png");
	textureIdleRIGHT[4].loadFromFile("resource/texturePack/idleRightText/image_part_005.png");
	textureIdleRIGHT[5].loadFromFile("resource/texturePack/idleRightText/image_part_006.png");
	textureIdleRIGHT[6].loadFromFile("resource/texturePack/idleRightText/image_part_007.png");
	textureIdleRIGHT[7].loadFromFile("resource/texturePack/idleRightText/image_part_008.png");
	textureIdleRIGHT[8].loadFromFile("resource/texturePack/idleRightText/image_part_009.png");
	textureIdleRIGHT[9].loadFromFile("resource/texturePack/idleRightText/image_part_010.png");
	textureIdleRIGHT[10].loadFromFile("resource/texturePack/idleRightText/image_part_011.png");

	/*IDLELEFT*/
	textureIdleLEFT[0].loadFromFile("resource/texturePack/idleLeftText/image_part_001.png");
	textureIdleLEFT[1].loadFromFile("resource/texturePack/idleLeftText/image_part_002.png");
	textureIdleLEFT[2].loadFromFile("resource/texturePack/idleLeftText/image_part_003.png");
	textureIdleLEFT[3].loadFromFile("resource/texturePack/idleLeftText/image_part_004.png");
	textureIdleLEFT[4].loadFromFile("resource/texturePack/idleLeftText/image_part_005.png");
	textureIdleLEFT[5].loadFromFile("resource/texturePack/idleLeftText/image_part_006.png");
	textureIdleLEFT[6].loadFromFile("resource/texturePack/idleLeftText/image_part_007.png");
	textureIdleLEFT[7].loadFromFile("resource/texturePack/idleLeftText/image_part_008.png");
	textureIdleLEFT[8].loadFromFile("resource/texturePack/idleLeftText/image_part_009.png");
	textureIdleLEFT[9].loadFromFile("resource/texturePack/idleLeftText/image_part_010.png");
	textureIdleLEFT[10].loadFromFile("resource/texturePack/idleLeftText/image_part_011.png");

	/*JUMPRIGHT*/
	textureJumpRIGHT[0].loadFromFile("resource/texturePack/jumpRightText/01.png");
	textureJumpRIGHT[1].loadFromFile("resource/texturePack/jumpRightText/02.png");

	/*JUMPLEFT*/
	textureJumpLEFT[0].loadFromFile("resource/texturePack/jumpLeftText/01.png");
	textureJumpLEFT[1].loadFromFile("resource/texturePack/jumpLeftText/02.png");

	/*RUNRIGHT*/
	textureRunRIGHT[0].loadFromFile("resource/texturePack/runRightText/01.png");
	textureRunRIGHT[1].loadFromFile("resource/texturePack/runRightText/02.png");
	textureRunRIGHT[2].loadFromFile("resource/texturePack/runRightText/03.png");
	textureRunRIGHT[3].loadFromFile("resource/texturePack/runRightText/04.png");
	textureRunRIGHT[4].loadFromFile("resource/texturePack/runRightText/05.png");
	textureRunRIGHT[5].loadFromFile("resource/texturePack/runRightText/06.png");
	textureRunRIGHT[6].loadFromFile("resource/texturePack/runRightText/07.png");
	textureRunRIGHT[7].loadFromFile("resource/texturePack/runRightText/08.png");
	textureRunRIGHT[8].loadFromFile("resource/texturePack/runRightText/09.png");
	textureRunRIGHT[9].loadFromFile("resource/texturePack/runRightText/10.png");
	textureRunRIGHT[10].loadFromFile("resource/texturePack/runRightText/11.png");
	textureRunRIGHT[11].loadFromFile("resource/texturePack/runRightText/12.png");
	textureRunRIGHT[12].loadFromFile("resource/texturePack/runRightText/13.png");

	/*RUNLEFT*/
	textureRunLEFT[0].loadFromFile("resource/texturePack/runLeftText/01.png");
	textureRunLEFT[1].loadFromFile("resource/texturePack/runLeftText/02.png");
	textureRunLEFT[2].loadFromFile("resource/texturePack/runLeftText/03.png");
	textureRunLEFT[3].loadFromFile("resource/texturePack/runLeftText/04.png");
	textureRunLEFT[4].loadFromFile("resource/texturePack/runLeftText/05.png");
	textureRunLEFT[5].loadFromFile("resource/texturePack/runLeftText/06.png");
	textureRunLEFT[6].loadFromFile("resource/texturePack/runLeftText/07.png");
	textureRunLEFT[7].loadFromFile("resource/texturePack/runLeftText/08.png");
	textureRunLEFT[8].loadFromFile("resource/texturePack/runLeftText/09.png");
	textureRunLEFT[9].loadFromFile("resource/texturePack/runLeftText/10.png");
	textureRunLEFT[10].loadFromFile("resource/texturePack/runLeftText/11.png");
	textureRunLEFT[11].loadFromFile("resource/texturePack/runLeftText/12.png");
	textureRunLEFT[12].loadFromFile("resource/texturePack/runLeftText/13.png");
...
// Placing the ground to make the map
...
// Function handling for animations (Player, Coin, Water)
